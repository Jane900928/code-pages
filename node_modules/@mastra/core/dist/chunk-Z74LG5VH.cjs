...
var CoreToolBuilder = class extends chunkYT4RGZYO_cjs.MastraBase {
  ...
  getParameters = () => {
    if (chunkWSGW2223_cjs.isVercelTool(this.originalTool)) {
  ...
  createExecute(tool, options, logType) {
    ...
    const execFunction = async (args, execOptions) => {
      if (chunkWSGW2223_cjs.isVercelTool(tool)) {
    ...
    return async (args, execOptions) => {
      ...
      try {
        ...
        const parameters = this.getParameters();
        const { data, error: error2 } = chunkWSGW2223_cjs.validateToolInput(parameters, args, options.name);
        if (error2) {
...
//# sourceMappingURL=chunk-Z74LG5VH.cjs.map
//# sourceMappingURL=chunk-Z74LG5VH.cjs.map