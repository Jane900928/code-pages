...
function createStep(params) {
  const wrapExecute = (execute) => {
    return async (executeParams) => {
      ...
      if (params instanceof chunkR4HT5XUH_cjs.Agent || params instanceof chunkWSGW2223_cjs.Tool) {
  ...
  if (params instanceof chunkR4HT5XUH_cjs.Agent) {
    return {
      id: params.name,
      // @ts-ignore
  ...
  if (params instanceof chunkWSGW2223_cjs.Tool) {
...
//# sourceMappingURL=chunk-MH64VYGF.cjs.map
//# sourceMappingURL=chunk-MH64VYGF.cjs.map