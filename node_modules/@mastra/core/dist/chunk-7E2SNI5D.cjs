...
_Mastra_decorators = [chunkGOE646WS_cjs.InstrumentClass({
  prefix: "mastra",
...
exports.Mastra = class Mastra {
  ...
  constructor(config) {
    ...
    this.#telemetry = chunkGOE646WS_cjs.Telemetry.init(config?.telemetry);
...
`
  ...
  setTelemetry(telemetry) {
    this.#telemetry = chunkGOE646WS_cjs.Telemetry.init(telemetry);
    if (this.#agents) {
      Object.keys(this.#agents).forEach(key => {
        if (this.#telemetry) {
...
//# sourceMappingURL=chunk-7E2SNI5D.cjs.map
//# sourceMappingURL=chunk-7E2SNI5D.cjs.map