...
var NewAgentNetwork = class extends chunkYT4RGZYO_cjs.MastraBase {
  ...
  async getRoutingAgent({ runtimeContext }) {
    ...
    const instructions = `
        ...
        `;
    return new chunkR4HT5XUH_cjs.Agent({
      name: "routing-agent",
      instructions,
      model: this.#model,
      memory: memoryToUse,
  ...
  async loop(messages, {
    ...
    const finalStep = chunkMH64VYGF_cjs.createStep({
      id: "final-step",
    ...
    const mainWorkflow = chunkMH64VYGF_cjs.createWorkflow({
  ...
  createWorkflow({ runtimeContext }) {
    ...
    const routingStep = chunkMH64VYGF_cjs.createStep({
      id: "routing-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
...
${completionResult.object.finalResult}` : ""}
    ...
    const agentStep = chunkMH64VYGF_cjs.createStep({
      id: "agent-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const workflowStep = chunkMH64VYGF_cjs.createStep({
      id: "workflow-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const toolStep = chunkMH64VYGF_cjs.createStep({
      id: "toolStep",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const finishStep = chunkMH64VYGF_cjs.createStep({
      id: "finish-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const networkWorkflow = chunkMH64VYGF_cjs.createWorkflow({
