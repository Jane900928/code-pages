...
import { z } from 'zod';
import type { AiMessageType, Mastra, Tool } from '../../index.js';
import { Agent } from '../../agent/index.js';
import type { MastraLanguageModel, UIMessageWithMetadata } from '../../agent/index.js';
...
export declare class NewAgentNetwork extends MastraBase {
    ...
    loop(messages: string | string[] | CoreMessage[] | AiMessageType[] | UIMessageWithMetadata[], { runtimeContext, maxIterations, threadId, resourceId, }: {
        runtimeContext?: RuntimeContext;
    ...
    loopStream(messages: string | string[] | CoreMessage[] | AiMessageType[] | UIMessageWithMetadata[], { runtimeContext, maxIterations, threadId, resourceId, }: {
        runtimeContext?: RuntimeContext;
        maxIterations?: number;
        threadId?: string;
        resourceId?: string;
    ...
    generate(messages: string | string[] | CoreMessage[] | AiMessageType[] | UIMessageWithMetadata[], { runtimeContext, threadId, resourceId, }: {
        runtimeContext?: RuntimeContext;
        threadId?: string;
        resourceId?: string;
    }): Promise<{
    ...
    stream(messages: string | string[] | CoreMessage[] | AiMessageType[] | UIMessageWithMetadata[], { runtimeContext, threadId, resourceId, }: {
        runtimeContext?: RuntimeContext;
        resourceId?: string;
        threadId?: string;
    }): Promise<{
