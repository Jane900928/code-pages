...
var MessageList = class _MessageList {
  ...
  static isVercelUIMessage(msg) {
    return !_MessageList.isMastraMessage(msg) && chunkZ74LG5VH_cjs.isUiMessage(msg);
  }
  static isVercelCoreMessage(msg) {
    return !_MessageList.isMastraMessage(msg) && chunkZ74LG5VH_cjs.isCoreMessage(msg);
  }
...
//# sourceMappingURL=chunk-DCOKWJ5G.cjs.map
//# sourceMappingURL=chunk-DCOKWJ5G.cjs.map